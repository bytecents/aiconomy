...
/**
 * Provides localized prompt templates for budget analysis in English, Chinese, and Japanese.
 * <p>
 * This class extends {@link BasePromptTemplate} and supplies Jinja2-style templates
 * for generating budget analysis prompts in multiple languages. The templates include
 * placeholders for budget details and support iteration over category budgets.
 * </p>
 */
public class Prompt extends BasePromptTemplate {

    /**
     * English prompt template for budget analysis.
     * Contains placeholders for total budget, spent amount, alerts, and category budgets.
     */
    ...
    /**
     * Chinese prompt template for budget analysis.
     * Contains placeholders for total budget, spent amount, alerts, and category budgets.
     */
    ...
    /**
     * Japanese prompt template for budget analysis.
     * Contains placeholders for total budget, spent amount, alerts, and category budgets.
     */
    ...
    /**
     * Constructs a new {@code Prompt} instance with English, Chinese, and Japanese templates.
     */
    public Prompt() {
